...
rankall <- function(outcome, num="best") {
  ...
  data <- read.csv("C:/Users/Dhan/Work/DataScience/R/Programming Assignment 3/rprog-data-ProgAssignment3-data/outcome-of-care-measures.csv",  colClasses="character")
